...
class StartingDataset(torch.utils.data.Dataset):
    ...
    """
    # "/Users/haleigh/haleigh/cassava-leaf-disease-classification/train.csv"

    def __init__(self, train = False): 
        self.dataframe = pd.read_csv("C:/Users/dwatt/Downloads/cassava-leaf-disease-classification/train.csv")
